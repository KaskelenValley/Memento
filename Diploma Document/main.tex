...
\def\myauthor{Adil Akhmetov, Aruzhan Makhmutova, Balzhan Jumabekova, Madiyar Mukushev, Timur Demenov} % author
\def\mycoach{Ardak Shalkarbayev} % coach, adviser etc.
\def\mytitle{Development of audio journaling application Memento for people with cognitive impairments} % title
